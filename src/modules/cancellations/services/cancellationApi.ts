...
//   WRONG_COMPLAINT: "Wrong Complaint",
...
//     description: "Customer informed dealer that service is no longer required.",

//     requestedBy: "FastFix Appliances",

//     requestedByRole: "DEALER",

//     requestedAt: "2026-08-25T10:00:00",
...
//     reasonLabel: "Dealer Unavailable",

//     description: "Dealer cannot support the request within SLA.",

//     requestedBy: "ABC Service Center",

//     requestedByRole: "DEALER",

//     requestedAt: "2026-08-24T12:30:00",
...
//       verifiedAt: "2026-08-24T13:00:00",
...
//     reasonLabel: "Duplicate Complaint",

//     requestedBy: "DG Team",

//     requestedByRole: "DG_TEAM",

//     requestedAt: "2026-08-23T09:00:00",
...
//       verifiedAt: "2026-08-23T09:30:00",

//       customerConfirmedCancellation: true,

//       verificationMethod: "CALL",
//     },

//     approvalRemarks: "Duplicate complaint confirmed.",

//     approvedBy: "DG Manager",

//     approvedAt: "2026-08-23T10:00:00",
...
// export async function getCancellationById(id: string) {
//   await delay();

//   return cancellations.find((item) => item.id === id);
// }
...
//     complaintNumber: payload.complaintId,
...
//     reasonLabel: CANCELLATION_REASON_LABELS[payload.reason],
...
//   const request = cancellations.find(
//     (item) => item.id === payload.cancellationId,
//   );
...
//     customerConfirmedCancellation: payload.customerConfirmedCancellation,
...
// export async function approveCancellation(payload: ApproveCancellationPayload) {
//   await delay();
...
//     throw new Error("Customer verification is required before approval");
//   }
...
// export async function rejectCancellation(payload: RejectCancellationPayload) {
//   await delay();
