...
import { downloadDistrictSampleExcel } from "../services/districtExcelService";
...
export default function DistrictExcelActions({
  importing = false,
  onImport,
  onExport,
}: Props) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      {hasPermission("district.import") && (
        <button
          type="button"
          onClick={downloadDistrictSampleExcel}
