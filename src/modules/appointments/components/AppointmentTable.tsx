              ...
              <div className="flex items-start justify-between gap-3 border-b border-gray-100 p-4">
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-xs text-gray-400">
                    {formatDate(appointment.complaintDateTime)} •{" "}
                    {formatTime(appointment.complaintDateTime)}
                  </p>
                </div>
              ...
              <div className="p-4">
                ...
                <div className="grid grid-cols-2 gap-x-4 gap-y-4 py-4">
                  ...
                  <div>
                    ...
                    {appointment.categoryId?.description && (
                  ...
                  <div>
                    <p className="text-xs text-gray-400">Complaint Type</p>
                    ...
                    appointment.pendingReason && (
                      <div className="col-span-2 rounded-lg border border-yellow-200 bg-yellow-50 p-3">
                        ...
                        <p className="mt-1 text-sm font-semibold text-yellow-800">
                          {formatReason(appointment.pendingReason)}
                        </p>
                      </div>
                    )}
                    ...
                    appointment.cancellationReason && (
                      <div className="col-span-2 rounded-lg border border-red-200 bg-red-50 p-3">
                        ...
                        <p className="mt-1 text-sm font-semibold text-red-800">
                          {formatReason(appointment.cancellationReason)}
                        </p>
                      </div>
                    )}
                </div>
                    ...
                    <div className="border-t border-gray-100 py-4">
                      ...
                      <select
                        ...
                        onChange={(e) => {
                          ...
                          onStatusChange?.(appointment._id, selectedStatus);
                        }}
                ...
                {!isDealer && appointment.allocatedDealerId && (
                  <div className="col-span-2 rounded-lg border border-indigo-100 bg-indigo-50 p-3">
                    ...
                    <div className="mt-2 grid grid-cols-2 gap-3">
                      <div>
                        <p className="text-xs text-gray-400">Firm Name</p>
                      ...
                      <div>
                        <p className="text-xs text-gray-400">Head Code</p>
                      ...
                      <div>
                        ...
                        {appointment.allocatedDealerId.mobileNumber ? (
                          <a
...
<div className="space-y-3 md:hidden">
  {appointments.map((appointment) => {
    ...
    // If your backend uses REGISTERED instead of NEW,
    // keep both conditions here.
    ...
    return (
      <div
        ...
        className={`
          ...
          transition
          active:scale-[0.99]
          ${getCardBorderColor(appointment.status)}
        `}
      >
        {/* =========================
            TOP ROW
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            <p className="mt-0.5 truncate text-sm font-bold text-[#123B7A]">
              {appointment.complaintNumber || "-"}
            </p>
          </div>

          <div className="shrink-0">
            <AppointmentStatusBadge status={appointment.status ==="ALLOCATED"?"NEW":appointment.status} />
          </div>
        </div>
        ...
        <div className="mt-3">
          ...
          <div className="mt-1 flex flex-wrap items-center gap-x-2 gap-y-1">
            {appointment.phone ? (
              ...
              <span className="text-xs text-gray-400">No mobile</span>
            )}
        ...
        {/* =========================
            NEW COMPLAINT ACTIONS
        ========================= */}

        {isNewComplaint && (
          <div
            className="mt-3 grid grid-cols-3 gap-2 border-t border-gray-100 pt-3"
            onClick={(e) => e.stopPropagation()}
          >
            {/* APPOINTMENT */}
                  ...
                  <div className="border-r border-gray-100 px-3 py-2.5">
                    ...
                    {appointment.categoryId?.description && (
                      <p
                        ...
                        title={appointment.categoryId.description}
                      >
                        {appointment.categoryId.description}
                      </p>
                    )}
          ...
          ========================== */}
                ...
                <div className="grid grid-cols-12 gap-0 border-t border-gray-100 bg-gray-50/60">
                  ...
                  >
                    ...
                    <p
                      className="mt-0.5 truncate text-[11px] text-gray-600"
                      title={appointment.faultReported || ""}
                    >
                      {appointment.faultReported || "-"}
                    </p>
                  </div>
                    ...
                    appointment.pendingReason ? (
                      <>
                        ...
                        <p
                          ...
                          title={formatReason(appointment.pendingReason)}
                        >
                          {formatReason(appointment.pendingReason)}
                        </p>
                      </>
                      ...
                      <>
                        ...
                        <p
                          ...
                          title={formatReason(appointment.cancellationReason)}
                        >
                          {formatReason(appointment.cancellationReason)}
                        </p>
                      </>
