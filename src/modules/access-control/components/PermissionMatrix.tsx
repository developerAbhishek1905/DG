        ...
        <table className="w-full min-w-[1000px] border-collapse">
          ...
          <thead>
            ...
            <tr className="border-b border-gray-200 bg-gray-50">
              ...
              <th className="sticky left-0 z-10 min-w-[220px] bg-gray-50 px-5 py-4 text-left text-xs font-semibold uppercase tracking-wide text-gray-500">
              ...
              {ACTIONS.map(
                (action) => (
                  ...
                  <th
                    key={action}
                    className="min-w-[100px] px-3 py-4 text-center"
                  >
              ...
              <th className="min-w-[110px] px-3 py-4 text-center text-xs font-semibold uppercase text-gray-500">
